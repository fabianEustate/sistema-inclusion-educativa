...
export default function Page() {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            console.log("📌 Enviando al backend:", JSON.stringify(noticiaCompleta, null, 2));

            const respuesta = await noticiasService.crearNoticia(noticiaCompleta);

            console.log("Noticia creada →", respuesta);
