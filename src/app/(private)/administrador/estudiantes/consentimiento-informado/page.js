      ...
      <Card className={styles.card}>
        <form>
          ...
          <div className={styles.consentimientoTexto}>
            <p>
              Yo, <span className={styles.dato}>{form.nombres || '__________'}</span>, identificado
              con la cédula de ciudadanía N° <span className={styles.dato}>{form.documento ||
                '__________'}</span>,
              autorizo al equipo de trabajo de Educación inclusiva e Intercultural, del programa de
              Bienestar Institucional de la Universidad Popular del Cesar, para que lleven a cabo todo lo
              relacionado con el proceso de acompañamiento y seguimiento.
              <br />
          ...
          <div className={styles.nota}>
            <b>Nota:</b> La Universidad Popular del Cesar garantiza la confidencialidad del presente
            proceso.
          </div>
          <div className={styles.observaciones}>
            ...
            <ul>
              ...
              <li>Su participación no genera riesgo a su salud y bienestar. Cualquier daño demostrable
                ocasionado a su bienestar físico o mental, así como a sus propiedades, es responsabilidad de los
                profesionales.</li>
              <li>Usted tiene derecho a pedir la restitución de sus derechos.</li>
              <li>Sus datos y resultados serán usados de manera confidencial, según la ley
                1581(Proteccion de datos).</li>
              <li>La única excepción es si alguna autoridad judicial competente(por ejemplo, fiscalia)
                solicita a los profesionales
                del equipo de educación inclusiva e intercultural de la Universidad Popular del Cesar
                el acceso a la información, o si hay inminencia de riesgo al bienestar físico o mental
                suyo.</li>
