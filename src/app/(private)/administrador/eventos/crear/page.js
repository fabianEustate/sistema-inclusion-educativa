...
import usuariosService from "@/services/usuarios/usuarios_service"; 
import eventosService from "@/services/eventos/eventos_service";
...
const CrearEvento = ({ eventoInicial = null, onGuardar, onCancelar }) => {
  ...
  /*const [formData, setFormData] = useState({
    ...
    id_usuario: 1,//eventoInicial?.id_usuario || '',
    id_direccion: 1 //eventoInicial?.id_direccion || ''
  });*/

  const [errors, setErrors] = useState({});

  // =======================
  // 🔥 Cargar usuarios aquí
  // =======================
  useEffect(() => {
  ...
  const handleSubmit = async () => {
    ...
    if (Object.keys(validationErrors).length === 0) {
      const eventoData = {
        ...
        tema: formData.tema,
        tipo_asistencia: formData.tipo_asistencia
      };

      console.log("JSON a enviar:", eventoData);
      try {
        const response = await eventosService.crearEvento(eventoData);
      ...
      >
        <div className="p-fluid">
          <div className="grid">
            ...
            {/* ========================== */}
            {/* 🔥 REEMPLAZADO POR DROPDOWN */}
            {/* ========================== */}
            <div className="col-12 md:col-6">
              <div className={styles.campo}>
                <label htmlFor="id_usuario" className={styles.label}>
                  Usuario Responsable <span className={styles.requerido}>*</span>
                </label>
                ...
                <Dropdown
                  ...
                  onChange={(e) => handleInputChange('id_usuario', e.value)}
            ...
            {/* campo de id_direccion lo dejo como está */}
            {/*<div className="col-12 md:col-6">
              <div className={styles.campo}>
