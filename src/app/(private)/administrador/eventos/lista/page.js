...
const guardarEvento = (eventoData) => {
  ...
  const eliminarEvento = async (evento) => {
    try {
      await eventosService.eliminarEvento(evento.id_evento);
  ...
  useEffect(() => {
    const cargarEventos = async () => {
      try {
        ...
        console.log("RESPUESTA EVENTOS:", res);

        // algunas APIs devuelven "items", otras devuelven la lista directamente
  ...
  console.log("EVENTOS EN ESTADO:", eventos);
